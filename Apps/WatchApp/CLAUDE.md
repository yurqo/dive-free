...
- The action **pill** is shown whenever the screen is on (surface and underwater, hidden only in AOD/luminance-reduced) so the diver always sees what the Action button will drop.
